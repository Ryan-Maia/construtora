        ...
        <form method="post">
            ...
            <div class="form-group">
                <div class="form-row">
                    ...
                    <div class="col-xl-4"><input class="form-control" type="text" name="quant" placeholder="Quantidade" autocomplete="off" inputmode="numeric"></div>
                </div>
            </div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit">vender</button></div>
        </form>
    </div>
